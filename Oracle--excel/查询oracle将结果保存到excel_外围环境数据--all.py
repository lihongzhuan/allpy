...
forma_decimal = book.add_format({'num_format': '#,##0.00','font_size': 9, 'align': 'center','valign': 'vcenter'})
...
forma_list = [forma_int,forma_char,forma_decimal,forma_date,forma_decimal,forma_char]
# ，forma_date,forma_decimal,forma_char
print("forma type is 'type(forma)%'",type(forma))
...
#     print(col,field)
    sheet1.write(0,col,field,forma_head)
    print(width[col])
    sheet1.set_column(int(col),int(width[col]))
print ("========success 完成写表头=========")    
...
#     print ("d%",row) 
    for col,field in enumerate(data):
        sheet1.write(row,col,field,forma_list[col])
        # print(type(row))
...
print("========完成在工作表1：  < "  + bookname+ ">  " + "写入sheet  <" +  sheetname +">")
# =======================FIRST   END=================
...
print("========完成在工作表2：  < "  + bookname+ ">  " + "写入sheet  <" +  sheetname +">")
# =======================SECOND END=============
...
#     print ("d%",row) 
    for col,field in enumerate(data):
        sheet3.write(row,col,field,forma_list[col])
        #print(type(row))
        #print（row）
        #print（col）
        #print（field）
...
print("========完成在工作表3：  < "  + bookname+ ">  " + "写入sheet  <" +  sheetname +">")
# =======================3END=============
...
print("========完成在工作表4：  < "  + bookname+ ">  " + "写入sheet  <" +  sheetname +">")
# =======================4END=============
