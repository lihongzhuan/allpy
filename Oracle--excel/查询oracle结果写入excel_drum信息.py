...
forma_list = [forma_int,forma_char,forma_date,forma_date,forma_decimal,forma_char,forma,forma,forma,forma_int,forma,forma,forma,forma,forma,forma,forma,forma,forma,forma,forma,forma,forma,forma,forma,forma,forma,forma]
...
sheet.write(0,col+1,'断点率',forma_head)    
print ("========success 完成写表头=========")    
...
#     print ("d%",row) 
    for col,field in enumerate(data):
        ...
        sheet.write_formula(row,col+1,'=1000*J'+str(row)+'/'+'E'+str(row),forma_decimal)
        #print(type(row))
        #print（row）
        #print（col）
        #print（field）
