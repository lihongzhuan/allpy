...
def sql_dao(da, cus):
    ...
    sql = '''INSERT INTO TB_RIC VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')''' % (da[0], da[1], da[2], da[3], da[4], da[5], da[6], da[7], da[8], da[9], da[10], da[11],da[12])
    cus.execute(sql)
...
if __name__ == '__main__':
    ...
    dbname = r'D:/py/05RIC组装表/RIC+RIT组装记录集.db3'
    xlsname = r'D:/py/05RIC组装表/RIC组装表.xlsx'
