...
# print(row)
print("========SUCCESS to get alldata from oracle =========")
...
for col,field in enumerate(fields):
    ...
    xlSheet.Cells(1,col+1).Font.Size = 14
    xlSheet.Cells(1,col+1).RowHeight = w[col]
print ("========success 完成写表头=========")    
...
for data in alldata:
    ...
    for col,field in enumerate(data):
        ...
        # xlSheet.Cells(row+1,col+1).ColumnWidth = w[col+1]
        # xlSheet.Cells(row+1,col+1).Font.Size = 9
        # xlSheet.Cells(row+1,col+1).Font.Size = 9
        # print(type(row))
...
cursor.close()   
connection.close()
xlBook.SaveAs(pwd + bookname+ t+'_'+ str(ran) + '.xlsx')
xlApp.Visible = 1
xlApp.Workbooks.Open(pwd + bookname+ t+'_'+ str(ran) + '.xlsx')
