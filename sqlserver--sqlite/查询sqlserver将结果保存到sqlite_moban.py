...
# row = crsr.fetchone()  #读取查询结果,
alldata_sqlserver = crsr.fetchall()
# print(row)
...
cn = sqlite3.connect(r'G:/98sqlite/tns0001.db3')
    # 设定表名称及结构
cn.execute('''CREATE TABLE IF NOT EXISTS TNS0001
    (
    F_DeptNo TEXT ,
    F_BatchNo TEXT,
    F_Status TEXT,
    ...
    Fibre_Status TEXT,
    Limitation TEXT,
    fn004_AS_Dia_Buf_B FLOAT,
    fn005_AS_Dia_Fib_B FLOAT,
    ...
    fn031_AS_Pmd400_Pmd  TEXT,
    fn032_AS_Pmd400_PmdCoef FLOAT,
    fn033_AS_Pmd400NT TEXT,
